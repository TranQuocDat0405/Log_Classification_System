...
if __name__ == "__main__":
    ...
    print(classify_with_regex("File file1.txt uploaded successfully by user user2."))
    print(classify_with_regex("Disk cleanup completed successfully."))
    print(classify_with_regex("System reboot initiated by user user12."))
    print(classify_with_regex("what the fack!"))